(function() {
 ...
 - `)}`);
		...
		constructor({ shelfElement: t, controllerElement: e, lockControllerElement: s, hoverControllerElement: i, sideControllerElement: r, dependentSelector: o = ".shelf-aware", lockedClass: d = "locked", unlockedClass: E = "unlocked", hoverClass: x = "hoverable", noHoverClass: K = "not-hoverable", leftClass: P = "left-side", rightClass: G = "right-side", openClass: R = "show", closeClass: N = "hide", transitionClass: U = "transitioning", transitionDuration: B = 250, openDuration: J = -1, closeDuration: Z = -1, hoverable: W = !1, hoverDelay: X = 250, enterDelay: Y = -1, leaveDelay: tt = -1, locked: et = !1, side: st = "left", minWidth: it = "1023px", mediaQuery: rt = "", prefix: ot = "graupl-", key: nt = null, initializeClass: ht = "initializing", initialize: lt = !1 } = {}) {
			super({
				prefix: ot,
				key: nt,
				initializeClass: ht
			}), this._dom.shelf = t, this._dom.controller = e || null, this._dom.lockController = s || null, this._dom.hoverController = i || null, this._dom.sideController = r || null, this._dom.dependents = [], this._selectors.dependents = o, this._classes.locked = d || "", this._classes.unlocked = E || "", this._classes.hover = x || "", this._classes.noHover = K || "", this._classes.left = P || "", this._classes.right = G || "", this._classes.open = R || "", this._classes.close = N || "", this._classes.transition = U || "", this._durations.transition = B, this._durations.open = J, this._durations.close = Z, this._locked = new b(et), this._breakpoint = it, this._mediaQueryString = rt || "", this._side = st, this._side === "right" && (this._otherSide = "left"), this._hover = W, this._delays.hover = X, this._delays.enter = Y, this._delays.leave = tt, this._registerEvent("expand", { detail: { shelf: this } }), this._registerEvent("collapse", { detail: { shelf: this } }), this._registerEvent("lock", { detail: { shelf: this } }), this._registerEvent("unlock", { detail: { shelf: this } }), this._registerEvent("shiftSide", { detail: { shelf: this } }), this._registerEvent("enableHover", { detail: { shelf: this } }), this._registerEvent("disableHover", { detail: { shelf: this } }), this._addEventListener("grauplComponentInitialize", this.rootDOMElement, () => {
	...
	p.remove = (t, e, s) => k(_(t), m(e, s), (i) => S(i, { remove: t })), p.filter = (t, e, s) => k(_(t), m(e, s)), p.find = (t, e) => m(t ? _(t) : `[${y}]`, e);
	const I = (t = {}, e = document, s = ".navigation-shelf") => {
...
//# sourceMappingURL=navigation-shelf.js.map