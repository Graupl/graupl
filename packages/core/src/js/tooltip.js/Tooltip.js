 ...
 * @property {HTMLElement}                 _dom.controller              - The tooltip controller element.
...
class Tooltip extends Component {
   ...
   *  - tooltip: `tooltip-${key}`
   *  - controller: `tooltip-controller-${key}`
   */
  _setIds() {
    this.dom.tooltip.id = this.dom.tooltip.id || `tooltip-${this.key}`;
    this.dom.controller.id =
      this.dom.controller.id || `tooltip-controller-${this.key}`;
   ...
   *
   * - Adds a `click` listener to the controller that will hide the tooltip.
   *
   * @protected
   */
  _handleClick() {
