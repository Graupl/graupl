 ...
 * @property {HTMLElement}                 _dom.tooltipBubble           - The tooltip bubble element.
...
class Tooltip extends Component {
  ...
  constructor({
    ...
    tooltipBubbleElement = ".tooltip-bubble",
    showClass = "show",
    hideClass = "hide",
    ...
    this._dom.tooltipBubble = tooltipBubbleElement;
  ...
  _setIds() {
    ...
    this.dom.tooltipBubble.id =
      this.dom.tooltipBubble.id || `tooltip-bubble-${this.key}`;
