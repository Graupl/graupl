...
class Tabs extends Component {
  /**
   * The DOM elements within the tabs.
   *
   * @protected
   *
  ...
  /**
   * The root DOM element of the tabs.
   *
   * @protected
   *
   * @type {string}
  ...
  /**
   * The DOM elements within the tabs that cannot be reset or generated by the tabs itself.
   *
   * @protected
   *
   * @type {string[]}
   */
  _protectedDOMElements = ["tab"];

  /**
   * The query selectors used by the tabs.
   *
   * @protected
   *
   * @type {Object<string>}
  ...
  /**
   * The instantiated elements within the tabs.
   *
   * @protected
   *
  ...
  /**
   * The CSS classes to apply when the tabs is in various states.
   *
   * @protected
   *
  ...
  /**
   * The duration times (in milliseconds) for variouse aspects throughout the tabs.
   *
   * @protected
   *
   * @type {Object<number>}
