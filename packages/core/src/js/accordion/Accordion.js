...
class Accordion extends Component {
   ...
   * @property {HTMLElement[]} accordionControls          - The accordion controls.
   * @property {HTMLElement[]} expandController           - The expand all controller(s).
   * @property {HTMLElement[]} collapseController         - The collapse all controller(s).
   */
  _dom = {
    accordion: null,
    accordionItems: [],
    ...
    accordionControlContainer: null,
    accordionControls: [],
    expandController: [],
    collapseController: [],
  };
  ...
  /**
   * The root DOM element of the accordion.
   *
   * @protected
   *
   * @type {string}
  ...
  /**
   * The DOM elements within the accordion that cannot be reset or generated by the accordion itself.
   *
   * @protected
   *
   * @type {string[]}
   */
  _protectedDOMElements = ["accordion"];
   ...
   * @property {string} accordionControlContainer - The querySelector for the accordion control container.
   * @property {string} accordionControls         - The query selector string for accordion controls.
   * @property {string} expandController          - The query selector string for the expand all controller(s).
   * @property {string} collapseController        - The query selector string for the collapse all controller(s).
   */
  _selectors = {
    accordionItems: "",
    accordionItemToggles: "",
   ...
   *
   * If set to false, at least one accordion items must be open at all times.
   *
   * @protected
   *
   * @type {boolean}
  ...
  initialize() {
    try {
      ...
      addClass(this._classes.initialize, this.dom.accordion);
