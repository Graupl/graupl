(function() {
 ...
 - `)}`);
	...
	const B = /[\11\12\14\15\40]+/, w = "data-once", P = document;
	function E(t, e, s) {
	...
	function $(t, { add: e, remove: s }) {
		const i = [];
		E(t, "has") && E(t, "get").trim().split(B).forEach((o) => {
	...
	_.remove = (t, e, s) => O(m(t), k(e, s), (i) => $(i, { remove: t })), _.filter = (t, e, s) => O(m(t), k(e, s)), _.find = (t, e) => k(t ? m(t) : `[${w}]`, e);
