(function() {
 ...
 - `)}`);
	...
	f.remove = (t, e, i) => E(p(t), m(e, i), (s) => $(s, { remove: t })), f.filter = (t, e, i) => E(p(t), m(e, i)), f.find = (t, e) => m(t ? p(t) : `[${y}]`, e);
	const x = ({ options: t = {}, context: e = document, selector: i = ".disclosure" } = {}) => {
