(function() {
 ...
 - `)}`);
		...
		_storageKey = "alerts";
		_name = "Alert";
		constructor({ alertElement: t, controllerElement: e = null, showClass: r = "show", hideClass: s = "hide", transitionClass: i = "transitioning", transitionDuration: o = 150, showDuration: a = -1, hideDuration: w = -1, isHidden: I = !1, prefix: q = "graupl-", key: P = null, initializeClass: K = "initializing", initialize: F = !1 } = {}) {
			super({
				prefix: q,
				key: P,
				initializeClass: K
			}), this._dom.alert = t, this._dom.controller = e, this._classes.show = r || "", this._classes.hide = s || "", this._classes.transition = i || "", this._durations.transition = o, this._durations.show = a, this._durations.hide = w, this._hidden.value = I, this._hidden.commit(), this._registerEvent("show", { detail: { alert: this } }), this._registerEvent("hide", { detail: { alert: this } }), this._addEventListener("grauplComponentInitialize", this.rootDOMElement, () => {
