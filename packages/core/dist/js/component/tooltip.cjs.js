 ...
 - `)}`);
	...
	_validate() {
		...
		if (t.status || (this._errors = [...this._errors, ...t.errors], this._valid = !1), Object.keys(this._dom).length > 0) {
			const i = {};
			for (const o of Object.keys(this._dom)) Array.isArray(this._dom[o]) ? this._dom[o].forEach((h, f) => {
				i[`${o}Element[${f}]`] = h;
	...
	_closeOnBlur = !0;
	_name = "Tooltip";
	constructor({ tooltipElement: t, tooltipToggleElement: e, tooltipDescriptionElement: s, showClass: i = "show", hideClass: r = "hide", transitionClass: o = "transitioning", transitionDelay: h = 250, transitionDuration: f = 150, showDuration: v = -1, hideDuration: b = -1, openOnFocus: k = !1, closeOnBlur: D = !0, hoverType: C = "off", hoverDelay: $ = 250, enterDelay: O = -1, leaveDelay: T = -1, prefix: S = "graupl-", key: M = null, initializeClass: L = "initializing", initialize: z = !1 } = {}) {
		super({
			prefix: S,
			key: M,
			initializeClass: L
		}), this._dom.tooltip = t, this._dom.tooltipToggle = e, this._dom.tooltipDescription = s, this._classes.show = i || "", this._classes.hide = r || "", this._classes.transition = o || "", this._durations.transition = f, this._durations.transitionDelay = h, this._durations.show = v, this._durations.hide = b, this._openOnFocus = k, this._closeOnBlur = D, this._hoverType = C, this._delays.hover = $, this._delays.enter = O, this._delays.leave = T, this._registerEvent("show", { detail: { tooltip: this } }), this._registerEvent("hide", { detail: { tooltip: this } }), this._addEventListener("grauplComponentInitialize", this.rootDOMElement, () => {
			this.hide({ force: !0 });
		}), this._addEventListener("grauplComponentValidate", this.rootDOMElement, () => {
			const y = n("boolean", { isOpen: this._open }, { shouldThrow: !1 });
			y.status || (this._errors = [...this._errors, ...y.errors], this._valid = !1);
			const m = w({ hoverType: this._hoverType }, { shouldThrow: !1 });
	...
	_handleKeydown() {
		this._addEventListener("keydown", this.dom.tooltipToggle, (t) => {
			...
			this.currentEvent = "keyboard", _(t) === "Escape" && c(t);
		});
	}
	_handleKeyup() {
		this._addEventListener("keyup", this.dom.tooltipToggle, (t) => {
			...
			this.currentEvent = "keyboard", _(t) === "Escape" && (c(t), this.hide());
