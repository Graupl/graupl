...
| `$button-theme-map`             | A map of all properties, colors, and color shades used to generate all button variants. | `map.deep-merge($-button-theme-map, $button-theme-map)` |
