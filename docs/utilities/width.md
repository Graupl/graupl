...
| [`.max-w-stretch`](#max-w-stretch) | max-width | stretch |
| [`.max-w-full`](#max-w-full) | max-width | 100% |
| [`.max-w-quarter`](#max-w-quarter) | max-width | 25% |
| [`.max-w-half`](#max-w-half) | max-width | 50% |
| [`.max-w-three-quarters`](#max-w-three-quarters) | max-width | 75% |
| [`.max-w-third`](#max-w-third) | max-width | calc(100%/ 3) |
| [`.max-w-two-thirds`](#max-w-two-thirds) | max-width | calc(100%/ 1.5) |
| [`.max-w-half-screen`](#max-w-half-screen) | max-width | 50vw |
| [`.max-w-third-screen`](#max-w-third-screen) | max-width | calc(100vw/ 3) |
| [`.max-w-two-thirds-screen`](#max-w-two-thirds-screen) | max-width | calc(100vw/ 1.5) |
...
| [`.min-w-stretch`](#min-w-stretch) | min-width | stretch |
| [`.min-w-full`](#min-w-full) | min-width | 100% |
| [`.min-w-quarter`](#min-w-quarter) | min-width | 25% |
| [`.min-w-half`](#min-w-half) | min-width | 50% |
| [`.min-w-three-quarters`](#min-w-three-quarters) | min-width | 75% |
| [`.min-w-third`](#min-w-third) | min-width | calc(100%/ 3) |
| [`.min-w-two-thirds`](#min-w-two-thirds) | min-width | calc(100%/ 1.5) |
| [`.min-w-half-screen`](#min-w-half-screen) | min-width | 50vw |
