...
| `$heighteight-selector-prefix` | `"height-"` | The prefix for the `.h` utility classes. |
| `$max-height-selector-prefix` | `"max-h-"` | The prefix for the `.max-h` utility classes. |
| `$min-height-selector-prefix` | `"min-h-"` | The prefix for the `.min-h` utility classes. |
| `$heighteight-values` | `()` | Map of the `.h` utility classes. |
