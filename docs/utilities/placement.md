...
| `$place-content-selector-prefix` | `"place-content-"` | The prefix for the place content utility classes. |
| `$custom-place-content-properties` | `()` | [DEPRECATED] The custom properties and values for the place content utility classes. |
| `$place-items-selector-prefix` | `"place-items-"` | The prefix for the `.place-items-utility` utility classes. |
| `$custom-place-items-properties` | `()` | [DEPRECATED] The custom properties and values for the `.place-items-utility` utility classes. |
| `$place-self-selector-prefix` | `"place-self-"` | The prefix for the `.place-self-utility` utility classes. |
| `$custom-place-self-properties` | `()` | [DEPRECATED] The custom properties and values for the `.place-self-utility` utility classes. |
