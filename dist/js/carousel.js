(function() {
	...
	var g = class D {
		...
		initialize() {
			try {
				!this._crush && typeof window[this.scope] < "u" && (u(D, { storage: window[this.scope] }, { shouldThrow: !1 }).status || typeof window[this.scope].storage < "u" && typeof window[this.scope].scope < "u" && typeof window[this.scope].type < "u") && (this._storage = window[this.scope].storage);
			} catch {} finally {
 ...
 - `)}`);
	...
	p.remove = (t, e, r) => v(m(t), f(e, r), (s) => k(s, { remove: t })), p.filter = (t, e, r) => v(m(t), f(e, r)), p.find = (t, e) => f(t ? m(t) : `[${E}]`, e);
	const Q = (t = {}, e = document, r = ".carousel") => {
