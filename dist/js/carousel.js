(function() {
 ...
 - `)}`);
	...
	y.remove = (t, e, r) => v(_(t), p(e, r), (s) => T(s, { remove: t })), y.filter = (t, e, r) => v(_(t), p(e, r)), y.find = (t, e) => p(t ? _(t) : `[${w}]`, e);
