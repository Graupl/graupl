(function() {
 ...
 - `)}`);
		...
		_handleKeyup() {}
		_store() {
			this._shouldStore && (h(y, { storage: window.GrauplStorage }, { shouldThrow: !1 }).status || new y({ scope: "GrauplStorage" }), window.GrauplStorage.set({
		...
		_unstore() {
			this._shouldStore && h(y, { storage: window.GrauplStorage }, { shouldThrow: !1 }).status && window.GrauplStorage.clear({
				key: this.id !== "" ? this.id : this.key,
				type: this._storageKey
			});
		}
		...
		_removeEventListener(t, e, s, i = {}) {
			...
			let r = -1;
			this._listeners.forEach((o, l) => {
				o.type === t && o.element === e && o.listener === s && JSON.stringify(o.options) === JSON.stringify(i) && (r = l);
			...
			this.dom.accordionItemToggles.forEach((t) => {
				this._addEventListener("keydown", t, (e) => {
					...
					["Space", "Enter"].includes(s) ? (a(e), this.currentEvent = "keyboard") : this.optionalKeySupport && [
						...
						"Home",
						"End"
					].includes(s) && (a(e), this.currentEvent = "keyboard");
				});
	...
	g.remove = (t, e, s) => C(p(t), _(e, s), (i) => O(i, { remove: t })), g.filter = (t, e, s) => C(p(t), _(e, s)), g.find = (t, e) => _(t ? p(t) : `[${E}]`, e);
	const V = ({ options: t = {}, context: e = document, selector: s = ".accordion" } = {}) => {
