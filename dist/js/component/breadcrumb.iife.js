var Breadcrumb = (function() {
 ...
 - `)}`);
		...
		_dispatchEvent(t, e) {
			$(t, this), c(HTMLElement, { element: e }), e.dispatchEvent(this.events[t]);
		}
		...
		_shouldStore = !1;
		_toggle = !1;
		constructor({ breadcrumbItemElement: t, breadcrumbLinkElement: e = null, parentBreadcrumb: i, isToggle: s = !1, prefix: r = "graupl-", key: o = null, initializeClass: a = "initializing" }) {
			super({
				prefix: r,
				key: o,
				initializeClass: a
			}), this._dom.item = t, this._dom.link = e || null, this._elements.parent = i, this._toggle = s;
		}
		get isToggle() {
			return this._toggle;
		}
		...
		constructor({ breadcrumbElement: t, breadcrumbItemsSelector: e = ".breadcrumb-item", breadcrumbLinksSelector: i = ".breadcrumb-link", breadcrumbToggleSelector: s = ".breadcrumb-toggle", lockedClass: r = "locked", unlockedClass: o = "unlocked", openClass: a = "show", closeClass: p = "hide", transitionClass: L = "transition", transitionDuration: z = 250, openDuration: A = -1, closeDuration: j = -1, openOnFocus: F = !1, closeOnBlur: x = !1, minWidth: E = "", breakpoint: _ = "856px", autoOpen: b = !1, openInsideBreakpoint: Q = !1, openOutsideBreakpoint: w = !0, closeInsideBreakpoint: O = !0, closeOutsideBreakpoint: q = !1, lockInsideBreakpoint: V = !1, lockOutsideBreakpoint: P = !0, unlockInsideBreakpoint: K = !0, unlockOutsideBreakpoint: G = !1, locked: H = !1, mediaQuery: N = "", prefix: R = "graupl-", key: U = null, initializeClass: J = "initializing", initialize: Z = !1 }) {
			super({
				...
				key: U,
				initializeClass: J
			}), this._dom.breadcrumb = t, this._dom.breadcrumbItems = [], this._dom.breadcrumbLinks = [], this._dom.breadcrumbToggle = null, this._selectors.breadcrumbItems = e, this._selectors.breadcrumbLinks = i, this._selectors.breadcrumbToggle = s, this._elements.breadcrumbItems = [], this._classes.locked = r || "", this._classes.unlocked = o || "", this._classes.open = a || "", this._classes.close = p || "", this._classes.transition = L || "", this._durations.transition = z, this._durations.open = A, this._durations.close = j, this._openOnFocus = F, this._closeOnBlur = x, E !== "" && (console.warn("`minWidth` is deprecated and will be removed in a future release. Please set `breakpoint` instead."), _ === "" && (_ = E)), b && _ !== "" && (console.warn("`autoOpen` is deprecated and will be removed in a future release. Please set `openOutsideBreakpoint` and `closeInsideBreakpoint` to `true` instead."), w = b, O = b), this._breakpoint = _ || "", this._openInsideBreakpoint = Q, this._openOutsideBreakpoint = w, this._closeInsideBreakpoint = O, this._closeOutsideBreakpoint = q, this._lockInsideBreakpoint = V, this._lockOutsideBreakpoint = P, this._unlockInsideBreakpoint = K, this._unlockOutsideBreakpoint = G, this._mediaQueryString = N || "", this._locked.value = H, this._locked.commit(), this._registerEvent("expand", { detail: { breadcrumb: this } }), this._registerEvent("collapse", { detail: { breadcrumb: this } }), this._registerEvent("lock", { detail: { breadcrumb: this } }), this._registerEvent("unlock", { detail: { breadcrumb: this } }), this._addEventListener("grauplComponentInitialize", this.rootDOMElement, () => {
		...
		_createChildElements() {
			this.dom.breadcrumbItems.forEach((t) => {
				const e = t.querySelector(this.selectors.breadcrumbLinks), i = t.querySelector(this.selectors.breadcrumbToggle) !== null, s = new D({
					breadcrumbItemElement: t,
					breadcrumbLinkElement: e,
					parentBreadcrumb: this,
					isToggle: i
				});
				this.elements.breadcrumbItems.push(s), i && (this._elements.breadcrumbToggle = s);
			});
		}
