 ...
 - `)}`);
	...
	constructor({ alertElement: t, controllerElement: e = null, showClass: r = "show", hideClass: s = "hide", transitionClass: i = "transitioning", transitionDuration: o = 150, showDuration: a = -1, hideDuration: m = -1, isHidden: D = !1, prefix: O = "graupl-", key: S = null, initializeClass: M = "initializing", initialize: A = !1 } = {}) {
		super({
			...
			key: S,
			initializeClass: M
		}), this._dom.alert = t, this._dom.controller = e, this._classes.show = r || "", this._classes.hide = s || "", this._classes.transition = i || "", this._durations.transition = o, this._durations.show = a, this._durations.hide = m, this._hidden.value = D, this._hidden.commit(), this._registerEvent("show", { detail: { alert: this } }), this._registerEvent("hide", { detail: { alert: this } }), this._addEventListener("grauplComponentInitialize", this.rootDOMElement, () => {
			this.isHidden && this._conceal({
				emit: !1,
				transition: !1
			});
		}), this._addEventListener("grauplComponentValidate", this.rootDOMElement, () => {
			const E = n("boolean", { isHidden: this._hidden.value }, { shouldThrow: !1 });
...
function $(t, { add: e, remove: r }) {
	const s = [];
	y(t, "has") && y(t, "get").trim().split(C).forEach((o) => {
