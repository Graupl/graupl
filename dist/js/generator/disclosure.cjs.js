 ...
 - `)}`);
	...
	_handleClick() {
		this._addEventListener("click", this.dom.controller, (t) => {
			this.currentEvent = "mouse", t.button === 0 && (_(t), this.toggle());
	...
	_handleKeydown() {
		this._addEventListener("keydown", this.dom.controller, (t) => {
			...
			this.currentEvent = "keyboard", m(t) === "Escape" && _(t);
		});
	}
	_handleKeyup() {
		this._addEventListener("keyup", this.dom.controller, (t) => {
			switch (this.currentEvent = "keyboard", m(t)) {
				...
				case "Enter":
					...
					break;
				case "Tab":
					this.openOnFocus && (_(t), this.open());
					break;
			}
		}), this._addEventListener("keyup", this.dom.disclosure, (t) => {
			this.currentEvent = "keyboard", m(t) === "Escape" && (this.close(), _(t));
		});
	}
...
f.remove = (t, e, s) => b(k(t), g(e, s), (i) => S(i, { remove: t })), f.filter = (t, e, s) => b(k(t), g(e, s)), f.find = (t, e) => g(t ? k(t) : `[${E}]`, e);
const ot = ({ options: t = {}, context: e = document, disclosureSelector: s = ".disclosure", controllerSelector: i = ".disclosure-toggle" } = {}) => {
	f("graupl-disclosure-generator", s, e).forEach((r) => {
		const o = r.dataset.grauplDisclosureOptions ? JSON.parse(r.dataset.grauplDisclosureOptions.replace(/'/g, "\"")) || {} : {}, a = `${i}[data-graupl-disclosure-target="${r.id}"]`, [d] = f("graupl-disclosure-generator", a, e);
		if (!d) {
